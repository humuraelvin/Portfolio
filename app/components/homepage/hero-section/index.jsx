  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center py-16 lg:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          >
            ...
            <div className={`mb-4 sm:mb-6 text-lg sm:text-xl lg:text-2xl ${isDark ? 'text-light-darker' : 'text-gray-700'} animate-fade-in flex h-8`}>
              I&apos;m a <span className="text-primary ml-2" ref={el}></span>
            </div>
            <p className={`text-sm sm:text-base lg:text-lg ${isDark ? 'text-gray-300' : 'text-gray-700'} mb-6 sm:mb-8 max-w-xl leading-relaxed animate-slide-up`}>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-6 sm:mb-10 animate-slide-up">
              <motion.a
                ...
                target='_blank'
                className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg ${isDark ? 'bg-dark-lighter' : 'bg-light-darker'} text-primary hover:bg-primary hover:text-white transition-colors duration-300`}
              >
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href={personalData.socialMedia.instagram}
                target='_blank'
                className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg ${isDark ? 'bg-dark-lighter' : 'bg-light-darker'} text-primary hover:bg-primary hover:text-white transition-colors duration-300`}
              >
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href={personalData.socialMedia.leetcode}
                target='_blank'
                className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg ${isDark ? 'bg-dark-lighter' : 'bg-light-darker'} text-primary hover:bg-primary hover:text-white transition-colors duration-300`}
              >
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                href={personalData.socialMedia.twitter}
                target='_blank'
                className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg ${isDark ? 'bg-dark-lighter' : 'bg-light-darker'} text-primary hover:bg-primary hover:text-white transition-colors duration-300`}
              >
          ...
          >
            <div className="gradient-border w-full max-w-[300px] xs:max-w-[340px] sm:max-w-md">
              <div className="glass-card p-1">
                <div className={`relative ${isDark ? 'bg-dark-lighter' : 'bg-light-darker'} p-3 sm:p-4 rounded-xl overflow-hidden`}>
                  ...
                  <code className={`font-mono text-xs md:text-sm block overflow-x-auto ${isDark ? 'text-gray-300' : 'text-gray-700'} scrollbar-thin ${isDark ? 'scrollbar-thumb-gray-600' : 'scrollbar-thumb-gray-400'} scrollbar-track-transparent`}>
                    <div className="flex items-center">
                      <span className="text-primary">const</span>
                      <span className={`${isDark ? 'text-white' : 'text-gray-900'} ml-2`}>developer</span>
                      <span className={`${isDark ? 'text-gray-400' : 'text-gray-600'} ml-2`}>=</span>
                      <span className={`${isDark ? 'text-gray-400' : 'text-gray-600'} ml-2`}>{'{'}</span>
                    </div>
                    ...
                    <div className="ml-4">
                      <span className={`${isDark ? 'text-white' : 'text-gray-900'}`}>skills:</span>
                      <span className="text-secondary ml-2">[&apos;React&apos;, &apos;Node.js&apos;, &apos;Python&apos;]</span>,
                    </div>
                    
                    <div className="ml-4">
                      <span className={`${isDark ? 'text-white' : 'text-gray-900'}`}>isAvailable:</span>
                      <span className="text-accent ml-2">true</span>,
                    </div>
                    ...
                    <div className="ml-8">
                      ...
                      <span className="text-secondary ml-2">&apos;Let&apos;s connect!&apos;</span>;
                    </div>
                  ...
                  <div className={`mt-3 sm:mt-4 flex items-center text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
      ...
      <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2">
        ...
        >
          <p className={`text-xs sm:text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} mb-1 sm:mb-2`}>Scroll to explore</p>
